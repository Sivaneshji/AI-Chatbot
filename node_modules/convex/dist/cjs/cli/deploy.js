...
).addOption(new import_extra_typings.Option("--live-component-sources").hideHelp()).addOption(new import_extra_typings.Option("--partition-id <id>").hideHelp()).showHelpAfterError().action(async (cmdOptions) => {
